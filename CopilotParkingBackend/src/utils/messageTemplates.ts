export const messageTemplates = {
  initialGreeting: (user: any, event: any) => ({
    ...
    content: [
      ...
      `Your goal is to help the user register parking for the event as the following sequence (if being answered do not repeat the same question!):`,
      ...
      `3. (use the parkingConfirmation message template)After the user registers car plate, send the finalRecommendation message template`,
